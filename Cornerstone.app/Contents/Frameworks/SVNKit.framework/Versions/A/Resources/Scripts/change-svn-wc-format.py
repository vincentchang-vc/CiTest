...
class Entries:
  ...
  def write_format(self, format_nbr):
    ...
    #Alternate write_format that correctly replaces the first line in the entries
    #file with the formatted version number, maintaining newline consistency.
    #Previous implementation renamed to write_format_old (see below)
  ...
  def write_format_old(self, format_nbr):
